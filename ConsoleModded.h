...
void UpdateMenu()
{
	...
	if (temp != Changes)
	{
		...
		system("CLS");
		SetColour(1);
		cout << "\t             _____  _____ ____  _   _  _____  ____  _     _    _ _______ _____ ____  _   _  _____  " << endl;
		cout << "\t       /\\   |  __ \\|_   _/ __ \\| \\ | |/ ____|/ __ \\| |   | |  | |__   __|_   _/ __ \\| \\ | |/ ____| " << endl;
		cout << "\t      /  \\  | |__) | | || |  | |  \\| | (___ | |  | | |   | |  | |  | |    | || |  | |  \\| | (___   " << endl;
		cout << "\t     / /\\ \\ |  _  /  | || |  | | . ` |\\___ \\| |  | | |   | |  | |  | |    | || |  | | . ` |\\___ \\  " << endl;
		cout << "\t    / ____ \\| | \\ \\ _| || |__| | |\\  |____) | |__| | |___| |__| |  | |   _| || |__| | |\\  |____) | " << endl;
		cout << "\t   /_/    \\_\\_|  \\_\\_____\\____/|_| \\_|_____/ \\____/|______\\____/   |_|  |_____\\____/|_| \\_|_____/  " << endl;
		cout << "  \n\n\n \t\t\t\t\t\t\t>> MENU <<" << endl;
		SetColour(15);
		...
		AddContainsToggleMenu("Anti Spread\t\t\t", IAntiSpread, Vars::Misc::anti_spread);

		//--------------
		
		AddContainsToggleMenu("No Recoil\t\t\t", INoRecoil, Vars::Misc::no_recoil);
		...
		AddContainsToggleMenu("High Jump\t\t\t", IHighJump, Vars::Misc::SetGravitu);

		//--------------

		if (M_Index == IJumpValue)
		{
			SetColour(10);
			cout << "> Jump Value\t\t\t=\t[" << Vars::FloatAntInt::JumpValue << "] " << endl;
		}
		else
		{
			SetColour(15);
