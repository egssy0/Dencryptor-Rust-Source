...
int Render()
{
	...
	if (tWnd == GetForegroundWindow())
	{
		...
		//text without shadow
		DrawString((char*)"PastedExternal", 5, 15, 240, 240, 250, pFontSmall);

		//Fov
		//DrawCircle(Width / 2, Height / 2, 120, 10, 12);
		...
		//crosshair
		FillRGB(Width / 2 - 22, Height / 2, 44, 1, 255, 0, 255, 255);
		FillRGB(Width / 2, Height / 2 - 22, 1, 44, 255, 0, 255, 255);
	}
